...
import com.readbooks.fileupload.FileUploadUtil;
...
public class ReviewBoardController {
	...
	public String boardInsert(@ModelAttribute ReviewBoardVO reviewboard, HttpServletRequest request)
			throws IllegalStateException, IOException {

		int result = 0;
		String url = "";

		String attachmentfile = FileUploadUtil.fileUpload(reviewboard.getFile(), request);
		reviewboard.setReviewboard_attachmentfile(attachmentfile);
	...
	public String boardUpdate(@ModelAttribute ReviewBoardVO reviewboard, HttpServletRequest request)
			throws IllegalStateException, IOException {

		int result = 0;
		String url = "";
		String reviewboard_attachmentfile = "";

		System.out.println(reviewboard.getFile());
		if (!reviewboard.getFile().isEmpty()) {
			...
			reviewboard_attachmentfile = FileUploadUtil.fileUpload(reviewboard.getFile(), request);
