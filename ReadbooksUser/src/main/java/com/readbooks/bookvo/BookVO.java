...
public class BookVO {
	...
	private String book_detailimage;
	...
	public String getBook_detailimage() {
		return book_detailimage;
	}

	public void setBook_detailimage(String book_detailimage) {
		this.book_detailimage = book_detailimage;
	}
