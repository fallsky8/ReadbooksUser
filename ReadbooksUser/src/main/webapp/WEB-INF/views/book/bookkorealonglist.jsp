	...
	<div id="main">
		<article>
			<div id="sideMenu" class="side-menu">
				<a href="#" class="menu-item">국내 소설</a> <a href="#"
					class="menu-item">국내 장편 소설</a> <a href="#" class="menu-item">국내
					단편 소설</a>
			</div>
			<div id="korea">
				<div id="koreaform">
					<div id="koreacontents">
						...
						<c:choose>
							<c:when test="${not empty korealongbooklist}">
								<c:forEach var="korealongbook" items="${korealongbooklist}"
									varStatus="status">
									<table>
										<tr data-num="${korealongbook.book_number} ">
											<td>${korealongbook.book_number }</td>
											<td><img alt="책상세이미지"
												src="/resources/image/${korealongbook.book_image }"
												width="150" height="180"></td>
											<td>${korealongbook.book_name }</td>
											<td>${korealongbook.book_writer }|${korealongbook.book_publisher}</td>
											<td>${korealongbook.book_price}</td>
											<td><b>수량</b><input type="text" name="num" value="1"
												id="${korealongbook.book_number}" class="num" size="2"
