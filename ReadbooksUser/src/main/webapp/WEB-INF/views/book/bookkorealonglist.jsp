						...
						<c:choose>
							<c:when test="${not empty korealongbooklist}">
								<table id="keywords">
									...
									<tbody>
										<c:forEach var="korealongbooklist"
											items="${korealongbooklist}">
											<tr>
												<td>
													<article class="product"
														data-num="${korealongbooklist.book_number }">
														<header>
															<a
																href="/resources/image/${korealongbooklist.book_image }"
																data-toggle="lightbox"> <img
																src="/resources/image/${korealongbooklist.book_image }"
																class="img-fluid">
															</a> <img
																src="/resources/image/${korealongbooklist.book_image }">
														</header>
														<div class="content">
															<!-- 상품이름 -->
															<h1>${korealongbooklist.book_name}</h1>
															<!-- 상품 설명 -->
															<p>${korealongbooklist.book_writer }
														...
														<footer class="content">
															...
															<h2 class="full-price">${korealongbooklist.book_price}원</h2>

															<h2 class="price">${korealongbooklist.book_price}원</h2>
														</footer>
													</article>
												</td>
											</tr>
