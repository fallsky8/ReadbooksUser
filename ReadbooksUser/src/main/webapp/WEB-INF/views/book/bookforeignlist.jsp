						...
						<c:choose>
							<c:when test="${not empty foreignbooklist}">
								<table id="keywords">
									...
									<tbody>
										<c:forEach var="foreignbooklist" items="${foreignbooklist}">
											<tr>
												<td>
													<article class="product"
														data-num="${foreignbooklist.book_number }">
														<header>
															<a href="/resources/image/${foreignbooklist.book_image }"
																data-toggle="lightbox"> <img
																src="/resources/image/${foreignbooklist.book_image }"
																class="img-fluid">
															</a> <img
																src="/resources/image/${foreignbooklist.book_image }">
														</header>
														<div class="content">
															<!-- 상품이름 -->
															<h1>${foreignbooklist.book_name}</h1>
															<!-- 상품 설명 -->
															<p>${foreignbooklist.book_writer }
														...
														<footer class="content">
															...
															<h2 class="full-price">${foreignbooklist.book_price}원</h2>

															<h2 class="price">${foreignbooklist.book_price}원</h2>
														</footer>
													</article>
												</td>
											</tr>
